...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        if (permissionRepository.count() == 0) {
            createPermissions();
            entityManager.flush(); // fuerza escritura a BD antes de continuar
        }
    ...
    private void createUser(String username, String email, String password, String firstName, String lastName,
            String roleName) {
